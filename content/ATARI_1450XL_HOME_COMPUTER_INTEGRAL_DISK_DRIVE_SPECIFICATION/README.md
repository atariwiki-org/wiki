...
The driver shall obtain a four byte status from the disk controller and put the status in the handler supplied buffer (system location DVSTAT [$02EA](../$02EA/README.md)).
