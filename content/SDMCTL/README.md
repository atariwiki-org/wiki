...
To switch on the Display List Interrupt see [NMIEN](../NMIEN/README.md).  
---
/%  
%%tab-deutsch  
...
Diese Speicherzelle ist das Schattenregister zu [DMACTL](../DMACTL/README.md) (54272; $D400). Sie dient der Kontrolle des direkten Speicherzugriffs ("Direct Memory Access", [DMA](../DMA/README.md)) des ANTIC auf den Speicher des Atari. Der 6502-Prozessor wird während des direkten Speicherzugriffs abgeschaltet. Durch die Abschaltung des DMA des [ANTIC](../ANTIC/README.md) können Programme beschleunigt (ca. 30%) werden. Anhand folgender Aufstellung sieht man, wie die einzelnen Bits dieses Registers das Aussehen des Bildschirms kontrollieren:  
...
Zum Einschalten des Display List Interrupts siehe [NMIEN](../NMIEN/README.md).  
---
/%  
  
  
see also: [Player Missile Topics](../Pm_topics/README.md), [Display List Topics](../Displaylist_topics/README.md)  
  
previous: [CDTMF5](../CDTMF5/README.md)  
  
next: [SDLSTL](../SDLSTL/README.md),[SDLSTH](../SDLSTL/README.md)  
