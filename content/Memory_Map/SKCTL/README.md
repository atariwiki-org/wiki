...
|write|53775|$D20F|SKCTL|Serial Port Control|[SSKCTL](../SSKCTL/README.md)|all  
|read|53775|$D20F|SKSTAT|Serial Port Status|[SSKCTL](../SSKCTL/README.md)|all  
...
|5|Keyboard over-run. Reset BITs 7 to 5 (latches) to one writing any number to [SKREST](../SKREST/README.md) at 53770 ($D20A).  
...
previous: [IRQEN](../IRQEN/README.md),[IRQST](../IRQEN/README.md)  
  
next: [PORTA](../PORTA/README.md) of PIA  
