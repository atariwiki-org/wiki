...
Von BASIC wird diese Speicherstelle als [HIMEM](../MEMTOP/README.md) bezeichnet.  
  
Wenn ein Wechsel der Grafikstufe dazu führt, dass Speicher unterhalb der von [APPMHI](../APPMHI/README.md) angegebenen Adresse benötigt wird, dann wird der Bildschirm zurück in GRAPHICS 0 gesetzt, MEMTOP wird aktuallisert und ein Fehler wird ausgegeben. Andernfalls wird der Wechsel der Grafikstufe durchgeführt und MEMTOP wird auf den neuen Wert gesetzt.  
...
Siehe auch:  
*[MEMTOP](../TOPSTK/README.md) - BASIC MEMTOP/TOPSTK (Ende des Runtime Stack und damit des Ende des BASIC-Programmes)  
*[APPMHI](../APPMHI/README.md) - Adresse oberhalb derer die Bildschirmdaten und die Displaylist liegen können  
