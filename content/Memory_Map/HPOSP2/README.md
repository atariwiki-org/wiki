...
Values from 0 to 255, player is visible between 48 to 208 depending on playfield width (see [SDMCTL](../SDMCTL/README.md)) and width of player (see [SIZEP2](../SIZEP2/README.md)).  
...
Werte von 0 bis 255 möglich, Player sichtbar zwischen 48 bis 208 abhängig von der Spielfeldbreite (siehe [SDMCTL](../SDMCTL/README.md)) und Breite des Players (siehe [SIZEP2](../SIZEP2/README.md)).  
...
previous: [HPOSP1](../HPOSP1/README.md), [M1PF](../HPOSP1/README.md)  
  
next: [HPOSP3](../HPOSP3/README.md), [M3PF](../HPOSP3/README.md)  
