...
for switching between single and double line resolution see Bit 5 of [SDMCTL](../SDMCTL/README.md)  
  
for adjusting the vertical position in double line resolution see [VDELAY](../VDELAY/README.md)  
  
for setting the base address of the PM memory map see [PMBASE](../PMBASE/README.md)  
