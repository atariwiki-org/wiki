...
Itempl		= $11		; temporary integer low byte (for GOTO etc)
...
LAB_FOR
	...
	TXA				; copy index
	ADC	#$0D			; add FOR structure size-2
	TAX				; add to index
...
LAB_MMEC
	...
	PLA				; dump return address high byte
	JSR	LAB_IGBY		; update BASIC execute pointer (to chr past ")")
	RTS				;
...
LAB_KEYT
	...
	.byte	"LE",("T"+$80)	; $87 LET
	.byte	"DE",("C"+$80)	; $88 DEC		new command
	.byte	"GOT",("O"+$80)	; $89 GOTO
	.byte	"RU",("N"+$80)	; $8A RUN
	.byte	"I",("F"+$80)	; $8B IF
	.byte	"RESTOR",("E"+$80); $8C RESTORE	modified command
	.byte	"GOSU",("B"+$80)	; $8D GOSUB
	.byte	"RETIR",("Q"+$80)	; $8E RETIRQ	new command
	.byte	"RETNM",("I"+$80)	; $8F RETNMI	new command
	.byte	"RETUR",("N"+$80)	; $90 RETURN
	.byte	"RE",("M"+$80)	; $91 REM
	.byte	"STO",("P"+$80)	; $92 STOP
	.byte	"O",("N"+$80)	; $93 ON		modified command
	.byte	"NUL",("L"+$80)	; $94 NULL		modified command
	.byte	"IN",("C"+$80)	; $95 INC		new command
	.byte	"WAI",("T"+$80)	; $96 WAIT
	.byte	"LOA",("D"+$80)	; $97 LOAD		user to do this
	.byte	"SAV",("E"+$80)	; $98 SAVE		user to do this
	.byte	"DE",("F"+$80)	; $99 DEF
	.byte	"POK",("E"+$80)	; $9A POKE
	.byte	"DOK",("E"+$80)	; $9B DOKE		new command
	.byte	"CAL",("L"+$80)	; $9C CALL		new command
	.byte	"D",("O"+$80)	; $9D DO		new command
	.byte	"LOO",("P"+$80)	; $9E LOOP		new command
	.byte	"PRIN",("T"+$80)	; $9F PRINT
	.byte	"CON",("T"+$80)	; $A0 CONT
	.byte	"LIS",("T"+$80)	; $A1 LIST
	.byte	"CLEA",("R"+$80)	; $A2 CLEAR
	.byte	"NE",("W"+$80)	; $A3 NEW
	.byte	"WIDT",("H"+$80)	; $A4 WIDTH		new command
	.byte	"GE",("T"+$80)	; $A5 GET		new command
	.byte	"SWA",("P"+$80)	; $A6 SWAP		new command
	.byte	"BITSE",("T"+$80)	; $A7 BITSET	new command
	.byte	"BITCL",("R"+$80)	; $A8 BITCLR	new command
	.byte	"IR",("Q"+$80)	; $A9 IRQ		new command
	.byte	"NM",("I"+$80)	; $AA NMI		new command
	.byte	"TAB",("("+$80)	; $AB TAB(

	.byte	"T",("O"+$80)	; $AC TO
	.byte	"F",("N"+$80)	; $AD FN
	.byte	"SPC",("("+$80)	; $AE SPC(
	.byte	"THE",("N"+$80)	; $AF THEN
	.byte	"NO",("T"+$80)	; $B0 NOT
	.byte	"STE",("P"+$80)	; $B1 STEP
	.byte	"UNTI",("L"+$80)	; $B2 UNTIL		new command
	.byte	"WHIL",("E"+$80)	; $B3 WHILE		new command
	.byte	"OF",("F"+$80)	; $B4 OFF		new command
	...
	.byte	("^"+$80)		; $B9 ^
	.byte	"AN",("D"+$80)	; $BA AND
	.byte	"EO",("R"+$80)	; $BB EOR		new operator
	.byte	"O",("R"+$80)	; $BC OR
	.byte	">",(">"+$80)	; $BD >>		new operator
	.byte	"<",("<"+$80)	; $BE <<		new operator
	.byte	(">"+$80)		; $BF >
	.byte	("="+$80)		; $C0 =
	.byte	("<"+$80)		; $C1 <
	...
	.byte	"PO",("S"+$80)	; $C7 POS
	.byte	"SQ",("R"+$80)	; $C8 SQR
	.byte	"RN",("D"+$80)	; $C9 RND		modified function
	.byte	"LO",("G"+$80)	; $CA LOG
	.byte	"EX",("P"+$80)	; $CB EXP
	.byte	"CO",("S"+$80)	; $CC COS
	.byte	"SI",("N"+$80)	; $CD SIN
	.byte	"TA",("N"+$80)	; $CE TAN
	.byte	"AT",("N"+$80)	; $CF ATN
	.byte	"PEE",("K"+$80)	; $D0 PEEK
	.byte	"DEE",("K"+$80)	; $D1 DEEK		new function
	.byte	"SAD",("D"+$80)	; $D2 SADD		new function
	.byte	"LE",("N"+$80)	; $D3 LEN
	.byte	"STR",("$"+$80)	; $D4 STR$
	.byte	"VA",("L"+$80)	; $D5 VAL
	.byte	"AS",("C"+$80)	; $D6 ASC
	.byte	"UCASE",("$"+$80)	; $D7 UCASE$	new function
	.byte	"LCASE",("$"+$80)	; $D8 LCASE$	new function
	.byte	"CHR",("$"+$80)	; $D9 CHR$
	.byte	"HEX",("$"+$80)	; $DA HEX$		new function
	.byte	"BIN",("$"+$80)	; $DB BIN$		new function
	.byte	"BITTS",("T"+$80)	; $DC BITTST	new function
	.byte	"MA",("X"+$80)	; $DD MAX		new function
	.byte	"MI",("N"+$80)	; $DE MIN		new function
	.byte	"P",("I"+$80)	; $DF PI		new function
	.byte	"TWOP",("I"+$80)	; $E0 TWOPI		new function
	.byte	"VARPT",("R"+$80)	; $E1 VARPTR	new function
	.byte	"LEFT",("$"+$80)	; $E2 LEFT$
	.byte	"RIGHT",("$"+$80)	; $E3 RIGHT$
	.byte	"MID",("$"+$80)	; $E4 MID$
