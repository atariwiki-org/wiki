...
Tested with a Logitech Formula GP Wheel USB. Other Logitech Wheels might work. Please send feedback.
...
|  $12           |  3                 | Acceleration (Brake and Throttle)  | $272 (626)  | PADDL2 | LACCEL     |
|  $13           |  4                 | Throttle | $273 (627)  | PADDL3 | LTHROTL     |
|  $14           |  5                 | Brake | $274 (628)  | PADDL4 | LBRAKE     |

- Byte 1: Wheel movement ($00 = left, $80 = middle, $FF= right)
- Byte 2: Buttons 1-6
- Byte 3: Acceleration (Throttle and Brake) ($00 = Brake, $80 = idle, $FF= Throttle)
- Byte 4: Throttle ($00 = accelerate, $FF= idle)
