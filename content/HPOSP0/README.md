...
Values from 0 to 255, player is visible between 48 to 208 depending on playfield width (see [SDMCTL](../SDMCTL/README.md)) and width of player (see [SIZEP0](../SIZEP0/README.md)).  
...
Werte von 0 bis 255 möglich, Player sichtbar zwischen 48 bis 208 abhängig von der Spielfeldbreite (siehe [SDMCTL](../SDMCTL/README.md)) und Breite des Players (siehe [SIZEP0](../SIZEP0/README.md)).  
...
next: [HPOSP1](../HPOSP1/README.md), [M1PF](../HPOSP1/README.md)  
