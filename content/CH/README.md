...
The value $11 (or $51 or $91) for the HELP key does never appear in [CH](../CH/README.md)! It does appear in [KBCODE](../KBCODE/README.md) and is transferred from there to [HELPFG](../HELPFG/README.md).  
