...
- an example to save registers and variables in the language "Action!" [Interrupts_in_ACTION](../Interrupts_in_ACTION/README.md)  
...
- Set bit 7 in the [display list](../display_list_instruction_table/README.md) line you want the interrupt to occur  
- clear bit 7 of [NMIEN](../NMIEN/README.md) to disable the interrupt  
- set [VDSLST](../VDSLST/README.md) to your routine  
- set bit 7 of [NMIEN](../NMIEN/README.md) to enable the interrupt  
  
  
---
  
see also: [Display List Topics](../Displaylist_topics/README.md), [NMIEN](../NMIEN/README.md), [Display List Instruction table](../display_list_instruction_table/README.md)  
