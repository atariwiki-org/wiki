...
usage:         PRINT [filespec](../filespec/README.md) [1no1__1no2](../1no1__1no2/README.md) ]  
...
usage: REP/old string/new string/ \[1no1 [,1no2 \]] [AQ](../AQ/README.md)  
...
MAC65 [file1_file2_file3_file4](../file1_file2_file3_file4/README.md) ] ] [-A](../-A/README.md)[-D](../-D/README.md) ]  
...
[label](../label/README.md) [6502_instruction_directive](../6502_instruction_directive/README.md) [comment](../comment/README.md)  
...
40 .WORD PMBASE+[PLNO_4](../PLNO_4/README.md)*256 ; expression  
  
3.5 OPERATORS  
  
The following are the operators currently supported by MAC/65:  
  
[](..//README.md)  psuedo parentheses  
+     addition  
-     subtraction  
/     division  
- multiplication  
...
LDA [GEORGE_5](../GEORGE_5/README.md)*3      ;OK...the addition  
is performed before  
the multiplication  
LDA ( [GEORGE_5](../GEORGE_5/README.md)*3),Y ;See the need  
for both kinds of  
"parentheses"?  
...
55  .IF .DEF INTEGER .AND [VER-1_.OR_VER_--3](../VER-1_.OR_VER_--3/README.md)  
200 .BYTE >EXPLOT-1, >EXDRAW-1, >EXFILL-1  
300 LDA  # <[-_ADDRESS^-1](../-_ADDRESS^-1/README.md) +1  
305 CMP  # -1  
400 CPX  # 'A  
440 INC  #1+1  
...
usage:      [label](../label/README.md) *= expression  
...
directive:  .BYTE   [and_.SBYTE](../and_.SBYTE/README.md)  
  
purpose:    specifies the contents of individual  
bytes in the output object  
  
usage:  
[label](../label/README.md) .BYTE  [_exp](../_exp/README.md) (exp)(strvar)[expstrvar_...](attachments/expstrvar_...)  
[label](../label/README.md) .SBYTE [_exp](../_exp/README.md)(exp)(strvar)[expstrvar_...](attachments/expstrvar_...)  
...
usage:  
[label](../label/README.md) .CBYTE [_exp](../_exp/README.md)(exp)(strvar) [expstrvar...](attachments/expstrvar...)  
...
Directive:  DBYTE  [see_also_.WORD](../see_also_.WORD/README.md)  
  
purpose:    specifies Dual BYTE values to be  
placed in the output object.  
  
usage:      [label](../label/README.md) .DBYTE exp [exp_...](attachments/exp_...)  
...
usage:      [label](../label/README.md) .END  
...
usage:      [label](../label/README.md) .ERROR [string](../string/README.md)  
...
usage:  
[label](../label/README.md) .FLOAT floating-constant [flotation-constant...](attachments/flotation-constant...)  
...
usage:      [label](../label/README.md) .WORD exp [exp_...](attachments/exp_...)  
...
;  XIO command, channel [aux1aux2](../aux1aux2/README.md) [filespec](../filespec/README.md)  
;  
...
seen as LDA #[LABEL-3](../LABEL-3/README.md) / 256 by the cartridge  
seen as LDA #LABEL - [256](../256/README.md) by MAC/65  
...
128 -255 [operating_system_errors](../operating_system_errors/README.md)  
...
PRINT chan [bufferlength](../bufferlength/README.md)]  
...
INPUT chan,buffer [length](../length/README.md)  
...
XIO command,chan [aux1aux2](../aux1aux2/README.md)[filename](../filename/README.md)  
