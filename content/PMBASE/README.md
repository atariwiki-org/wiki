...
According to bit 4 of [DMACTL](../DMACTL/README.md):  
...
---
see also: [Player Missile Topics](../Pm_topics/README.md) [Pm-memory-map](../Pm-memory-map/README.md)  
  
previous: [VSCROL](../VSCROL/README.md)  
  
next: [CHBASE](../CHBASE/README.md)  
