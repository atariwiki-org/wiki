# Create an ATX image from KryoFlux raw files
...
**D:Atari...a8rawconv.exe -l -tpi 48 -if kryoflux -of atx -v D:Atari...input.raw D:Atari...output.atx \>D:Atari...report.log**
...
**./a8rawconv -b -l -if kryoflux -of atx -v input.raw output.atx \>report.log**

in case of trouble please use:

**./a8rawconv -l -tpi 48 -if kryoflux -of atx -v input.raw output.atx \>report.log**
