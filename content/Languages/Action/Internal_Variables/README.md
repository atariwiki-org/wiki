...
SET S491=$5000^ schreibt den Inhalt der Speicherzelle $5000 in die Speicherzelle $491. Falls der Inhalt von $5001 ungleich Null ist, wird er nach S492 transferiert. Auch hier sollte man ein bisschen vorsichtig sein.
...
Diese 1-Byte-Variable hat zwar nur mittelbaren Einfluss auf die Codeerzeugung, ist aber in vielen Fällen sehr wichtig. Sie gibt an, wie viele Pages für die Symboltabelle verwendet werden sollen. Die Voreinstellung dafür ist 8 (d.h. 2 KByte); bei langen Programmen mit vielen INCLUDES ist diese Grenze schnell erreicht.
