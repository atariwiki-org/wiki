...
2. Reboot your computer and enter the monitor. Type C “BIRDS”.
3. When the disk drive stops, type W “AUTORUN.SYS" to save the object code to disk.
4. Whenever you want to play **Demon Birds**, insert the Action! cartridge into the left slot. Insert the disk with the AUTORUN.SYS file into drive one and turn on the computer. The program will load and run automatically.

### Cassette instructions.

1. Type in Listing 1 and SAVE it to cassette. You must have at least 48K and the Action! cartridge.
2. Reboot your computer and enter the monitor. Type C "C:".
3. When the cassette stops, type W “C:" to save the object code to cassette.
4. Whenever you want to play **Demon Birds**, insert the Action! cartridge into the left slot. Insert the cassette with the object code into the cassette recorder. Turn on the computer and enter the monitor. Type R "C:". The program will load and run automatically.
   That's all there is to it. You're ready to do battle with the **Demon Birds**.
...
[analog\_28\_demonbirds.pdf](attachments/analog_28_demonbirds.pdf)
