...
If you want to solve this problem, you can set 'c\_t\_sp(index)' to zero before you return from the PROC that contained the Catch(index). If index is greater than 24 or if there is no matching Catch index
