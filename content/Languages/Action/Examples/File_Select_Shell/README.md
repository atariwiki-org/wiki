...
This code requires the [Binary File Load in ACTION](../Binary_File_Load_in_ACTION/README.md) Module and the [File Select Box](../File_Select_Box/README.md) Module
