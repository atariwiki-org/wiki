...
In der Assemblerecke dieses Monats gibt es eine besondere Premiere: Das erste Action!-Programm, das wir in Computer-Kontakt abdrucken, wenn nicht sogar dis erste in der gesamten deutschen Computer- Literatur. Action! ist schlicht gesagt eines der besten Software-Pakete, die für Atari-Computer je entwickelt wurden. Russ Wetmore bezeichnet es in einem Artikel ([Getting in on the Action! - Part 1](../../ACTION_Articles/Getting_in_on_the_Action_1/README.md)) als "Programmer's Dream' und ich kann Russ wirklich nur voll unterstützen.
...
PDF: [Musik\_in\_Action\_CK\_10\_85.pdf](attachments/Musik_in_Action_CK_10_85.pdf)
