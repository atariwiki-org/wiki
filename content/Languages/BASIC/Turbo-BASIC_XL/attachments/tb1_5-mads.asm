...
STMT_X_TAB  .word REM_CMD
            ...
            .word X_PPUT
            .word X_PGET
STATEMENT_TABLE_SIZE = *- STMT_X_TAB

;            ORG $2300-$30          
; MATH PACK temporary variables 
; Appears to used for 6502 Floating Point Math
XTAB2_00       .ds 8
XTAB2_08       .ds 8
XTAB2_10       .ds 8
XTAB2_18       .ds 8
...
;
            ...
            .word X_OR,X_AND,ON_EXEC_FUN,X_RPAREN
            .word X_FPASIGN,X_STRASIGN,X_LTE,X_NEQU
            .word X_GTE,X_LT,X_GT,X_EQU
            .word ON_GO_FUN,X_FNEG,X_STRLPAREN,X_ARRLPAREN
