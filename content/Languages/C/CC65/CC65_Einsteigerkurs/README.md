...
2. die Quelldatei des CC65 ändern und den CC65 aus den Quellen neu übersetzen
3. mit einem Hexeditor den Eintrag in ld65.exe ändern (Vorsicht, vorher eine Sicherheitskopie von ld65.exe anfertigen)
