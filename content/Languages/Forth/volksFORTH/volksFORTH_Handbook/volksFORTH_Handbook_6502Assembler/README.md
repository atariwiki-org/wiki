...
The operation of the interpreter and address of the routine NEXT is presented in [Chapter 2: Introduction to volksFORTH](../Chapter2/README.md). The 6502 assembler allows structured programming. The structural elements are constructed analogous to the control structures of the Forth but bear different names in order to reduce the risk of confusion and increase clarity.
