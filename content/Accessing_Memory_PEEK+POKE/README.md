...
C@ ( addr --  8b )
```
In the Atari, Memory location 632 ([STICK0](../STICK0/README.md)/$278) is the shadow register for the first joystick port ([PORTA](../PORTA/README.md)/54016).  
...
The below BASIC line changes the background color of the screen to black, writing the value 0 in memory location 709 ([COLOR1](../COLOR1/README.md)):  
