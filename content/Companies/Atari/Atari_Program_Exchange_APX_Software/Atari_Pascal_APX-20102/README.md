...
Please note that the Atari Program-Text Editor is required to generate Pascal source files. The program can be found in the Assembler chapter.
...
- [APX\_Atari\_Pascal\_Manual.pdf](../../../../../media/Companies/Atari/APX_Atari_Pascal/attachments/APX_Atari_Pascal_Manual.pdf) 8.6 MB PDF file, b/w only, searchable, Atari Pascal Language System manual (ISO Pascal)
- [APXPascal.djvu](attachments/APXPascal.djvu) 2.6 MB DJVU file

# Reviews

- [Atari Pascal Review](http://www.cyberroach.com/analog/an11/pascal.htm)
