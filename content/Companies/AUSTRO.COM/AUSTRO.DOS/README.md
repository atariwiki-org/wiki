...
Copyright (C) 1985 AUSTRO.COM und Walter Lederer, Gerhard Lederer \& Johann Wosp
...
**Derzeit laufen die AUSTRO.COM-Programme nur unter ATARI OS B - PAL**
...
(X) ; **Software von AUSTRO.COM, die nach gegenwärtigem Stand (2018) als verschollen gilt. Jeder Hinweis dazu wird von AtariWiki.org gerne entgegen genommen. :-)**

## ATX-Image

Leider haben wir derzeit keine Version von AUSTRO.DOS, insbesondere kein Original! Sofern jemand eine originale Diskette besitzt, würden wir uns sehr freuen, wenn diese leihweise zur Verfügung gestellt werden könnte. :-)))
...
Leider haben wir derzeit kein Handbuch von AUSTRO.DOS, insbesondere kein Original! Sofern jemand ein Original besitzt, würden wir uns sehr freuen, wenn dieses leihweise zur Verfügung gestellt werden könnte. :-)))
