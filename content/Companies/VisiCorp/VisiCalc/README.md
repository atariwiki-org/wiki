...
- [VisiCalc\_Data\_with\_DOS\_2.5\_SD\_Color.atr](attachments/VisiCalc_Data_with_DOS_2.5_SD_Color.atr) ; typical spreadsheet from VisiCalc on a DOS 2.5 Color diskette. For loading please type in '/SL', the filename and press RETURN.
...
- [DIF\_Technical\_Specification.pdf](attachments/DIF_Technical_Specification.pdf) ; Data Interchange Format (DIF) specifications to exchange data from Visicalc with other programs. Highly recommended! Thank you Bill. :-)
...
- [Spreadsheet\_Printout.txt](attachments/Spreadsheet_Printout.txt) ; typical printout of a normal Visicalc spreadsheet
- [VISICALC-Printout\_with\_Formulas.txt](attachments/VISICALC-Printout_with_Formulas.txt) ; printout of a normal Visicalc spreadsheet with formulas
